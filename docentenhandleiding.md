# Docentenhandleiding — Automata voor Staatsbosbeheer

**Vak:** Techniek · **Klas:** havo 2 · **Duur:** 8 lessen van 100 minuten · **Werkvorm:** groepjes van 2

> Dit bestand is **alleen voor de docent**. Het gaat niet het leerlingmateriaal in. De alignment-tabel en de verantwoording kerndoelen (onderaan) staan hier bewust, niet in de leerlingpagina.
...
## 2. Voorbereiding vóór les 1

### Wat je zelf één keer gemaakt moet hebben
**Bouw vóór les 1 zelf één automata met twee bewegingen op één as** (bijvoorbeeld een excenter + een nok). Dat kost je ongeveer een uur en het is niet optioneel: je voelt dan waar het wringt en dat is precies waar je leerlingen op vastlopen.
...
- Zet je tweede beweging er als laatste op. Je merkt dat díe het eerst hapert — dat is exact het patroon bij de leerlingen.
...
| Materiaal | Per groep (2 lln) | Per klas (14 groepen) |
|---|---|---|
| Multiplex **6 mm** (kast + 2 lagerwanden) | kastset ± 30 × 20 cm | 2 platen 120 × 60 cm |
| Houten **rondstok Ø6 mm** (as) | 2 × 30 cm | ± 10 m (of 10 stokken 1 m) |
| Satéprikkers (as proefmodel) | 4–5 | 1 doos (100) |
...
### Les 1 — Opdracht, figuur & beweging kiezen
| Onderdeel | Inhoud |
|---|---|
...
### Les 2 — Mechanisme kiezen & proefmodel
| Onderdeel | Inhoud |
|---|---|
...
### Les 5 — Mechaniek bouwen & eerste draaitest
| Onderdeel | Inhoud |
|---|---|
...
| **Veiligheid** | Vóór het lijmen: **lijmpistool op de standaard terugleggen, mondstuk ± 180 °C, bakje koud water binnen handbereik.** |
...
### Les 6 — Wrijving & speling oplossen
| Onderdeel | Inhoud |
|---|---|
...
### Les 7 — Afmonteren, koppelen & decoreren
| Onderdeel | Inhoud |
|---|---|
...
### Les 8 — Eindtest, finetunen & presenteren
| Onderdeel | Inhoud |
|---|---|
...
- **Wat je doet:** "Je loste de eerste beweging op met een rietje-lager én door de rand te schuren. Wat is er aan de **tweede** kant nog anders — wat heb je daar nog níet gedaan?" De leerling ontdekt dat hij zijn eigen aanpak nog niet op de tweede beweging heeft toegepast.
...
- **Signaal:** de beweging "springt" of tikt hoorbaar bij elke omwenteling; ze is niet vloeiend, ook al klemt niets.
...
- **Les 7 (koppelen + decoreren)** loopt door in les 8. *Wat je doet:* accepteer dat en plan les 8 zo dat finetunen en presenteren pas na een korte afmonteerronde komen. Loop je achter: kort de decoratie in tot "herkenbare figuur" — een werkende, sobere figuur scoort hoger dan een mooi maar haperende figuur, want de betrouwbaarheid van beide bewegingen (criterium 4) weegt zwaarder dan de afwerking.
...
|---|---|---|
| Les 2–3 | Mechanismekeuze en één-as-plan; kun je in eigen woorden uitleggen waarom dit mechanisme past? Proefmodel + tekening. | **1. Mechanismen begrijpen & de juiste keuze maken**; **2. Ontwerp: techniek en vormgeving werken samen** |
| Les 4 | Veilig boren: bril, vastgeklemd, geen loshangende kleding/haar; nauwkeurig aftekenen, zagen, uitlijnend boren. | **5. Veilig werken** (observeren); **3. Nauwkeurig maken en monteren** |
| Les 5–6 | De draaitest en het gericht oplossen van wrijving/speling — test bewust **beide** bewegingen na langer draaien; taakverdeling en of ze elkaar helpen. | **4. Testen, wrijving/speling oplossen & verbeteren** (observeren); **7. Samenwerken & feedback** (observeren) |
| Les 6 (peer-feedback) | Geven en ontvangen ze bruikbare feedback, en verwerken ze die zichtbaar? | **7. Samenwerken & feedback** |
| Les 7 | Stevige, verzorgde montage; versterkt de vormgeving de beweging? | **3. Nauwkeurig maken en monteren**; **2. Ontwerp: techniek en vormgeving werken samen** |
| Les 8 | Eindtest (5 min doordraaien): lopen beide bewegingen betrouwbaar? Presentatie mét werkend automata en deelvragen mét bewijs uit de dummy. | **4. Testen, wrijving/speling oplossen & verbeteren**; **6. Presenteren aan Staatsbosbeheer** |
...
## 9. Verantwoording kerndoelen & alignment

Deze sectie hoort in de docentenhandleiding — **niet** in het leerlingmateriaal.

### Alignment-tabel: leerdoel ↔ rubriccriterium ↔ kerndoel

| Leerdoel | Rubriccriterium | Kerndoel(en) |
|---|---|---|
| 1. Uitleggen hoe nok, krukas, excenter, hefboom, tandwiel een draaiende beweging overbrengen/omzetten | 1. Mechanismen begrijpen & de juiste keuze maken | KD30A, KD29B |
| 2. Bepalen welke mechanismen bij de twee bewegingen passen | 1. Mechanismen begrijpen & de juiste keuze maken | KD30A, KD29B |
| 3. Ontwerpen hoe je twee bewegingen op één as combineert (techniek + vormgeving één geheel) | 2. Ontwerp: techniek en vormgeving werken samen | KD30A, KD40A, KD41A |
| 4. Aftekenen, zagen, boren, monteren tot een nauwkeurig mechaniek | 3. Nauwkeurig maken en monteren | KD30A, KD29C |
| 5. Testen waar wrijving/speling zit, dat oplossen en verbeteren | 4. Testen, wrijving/speling oplossen & verbeteren | KD30B, KD29C, KD29B |
| 6. Veilig en zorgvuldig werken met gereedschap en machines | 5. Veilig werken | KD29C |
| 7. Presenteren hoe het automata werkt en waarom die mechanismen | 6. Presenteren aan Staatsbosbeheer | KD29C, KD29D |
| 8. Samenwerken, taken verdelen, feedback geven/ontvangen/verwerken | 7. Samenwerken & feedback | KD29D, KD40A (iteratief proces + reflectie) |
...
### Verantwoording kerndoelen (overgenomen uit `kerndoelen-automata-koppeling.csv`)
...
| Leergebied | Kerndoel | Sub | Dekking | Waar in het project (bewijs) |
|---|---|---|---|---|
| Mens en natuur | KD30 – Natuurkundige verschijnselen en technische systemen | 30A | **Sterk** | Mechanismentabel + keuze (les 1–2); kartonnen proefmodel (les 2); technische tekening met maten (les 3); asmontage + draaitest (les 5); eindeis ≥2 bewegingen; presentatie (les 8); rubriccriteria 1, 2, 3. |
| Mens en natuur | KD30 – Natuurkundige verschijnselen en technische systemen | 30B | **Sterk** | Les 6: wrijving en speling opsporen en oplossen (schuren, lager toevoegen, ruimte maken); stevige constructie; rubriccriteria 3 en 4. |
| Mens en natuur | KD29 – Natuurwetenschappen en technologie | 29A | **Deels** | Les 1: onderzoek naar drie bestaande automata; herkennen welk mechanisme welke beweging maakt; mechanismekeuze afwegen. Oriënterend, geen volledige onderzoeksopzet. |
| Mens en natuur | KD29 – Natuurwetenschappen en technologie | 29B | **Sterk** | Deelvraag 2 (draaien → andere beweging) en deelvraag 5 (waarom dit mechanisme); vorm-functie-relatie; oorzaak-gevolg bij wrijving (les 6); rubriccriteria 1 en 4. |
| Mens en natuur | KD29 – Natuurwetenschappen en technologie | 29C | **Sterk** | Iteratieve cyclus: mock-up (les 2) → tekening (les 3) → bouw (les 4–5) → testen/verbeteren (les 6 en 8); veilig gereedschapsgebruik; vaktaal bij de presentatie; rubriccriteria 3, 4, 5, 6. |
| Mens en natuur | KD29 – Natuurwetenschappen en technologie | 29D | **Deels** | Iteratief werken (les 2–8); mechanismekeuze tegen een alternatief afwegen; verbeterpunt in de presentatie (les 8). Expliciete reflectie op maakbaarheid/ethiek ontbreekt. |
| Mens en natuur | KD30 – Natuurkundige verschijnselen en technische systemen | 30C | **Niet** | Slinger-aangedreven. Toevoegen: laat (een groep) een elektromotor met schakeling als aandrijving maken om 30C te raken. |
| Kunst en cultuur | KD40 – Artistiek creatief vermogen | 40A | **Deels** | Bewegende figuur bedenken; figuur/beweging/mechanisme kiezen (divergeren → convergeren, les 1–2); ontwerp bijstellen na draaitest (les 6); rubriccriterium 2. Kunstzinnige reflectie is licht. |
| Kunst en cultuur | KD41 – Maakt kunstzinnige uitingen | 41A | **Deels** | Figuur en decoratie die de beweging versterken (les 6–7); vormgeving past bij Staatsbosbeheer-tentoonstelling; rubriccriterium 2. Toegepaste vormgeving, geen vrij kunstwerk. |
| Kunst en cultuur | KD41 – Maakt kunstzinnige uitingen | 41B | **Deels** | Figuur van karton/foamboard maken en decoreren (les 6–7); beeldend materiaal- en gereedschapsgebruik. |
| Digitale geletterdheid | KD21 – Ontwerpen en maken met digitale technologie | 21 | **Niet** | Optioneel: lasersnijder of 3D-printer voor nokken/onderdelen. Verplicht maken van digitaal fabriceren raakt KD21 "Deels". |

Samengevat: het project dekt **sterk** de mechanica- en ontwerpkern (KD30A, KD30B, KD29B, KD29C), **deels** het onderzoek, de systematiek en de creatief-kunstzinnige kant (KD29A, KD29D, KD40A, KD41A/B), en **nog niet** elektrische systemen (KD30C) en digitaal fabriceren (KD21) — die twee zijn via de verdiepingsroutes (elektromotor, 3D-print/laser) binnen bereik te brengen.
